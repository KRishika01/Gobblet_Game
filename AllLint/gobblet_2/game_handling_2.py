...
import math
import pygame
from game_logic_2 import Players,GobbletGameLogic
from game_dimensions_2 import (WIDTH,HEIGHT,BLACK,WHITE,RED,BLUE,GREEN,SIZE_BOARD,SIZE_CELL,BOARD_X,BOARD_Y,SIZE_PIECES)
